...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.GET, "/v1/localization").permitAll()
                .requestMatchers(HttpMethod.OPTIONS, "/v1/localization").permitAll()
                .requestMatchers(HttpMethod.OPTIONS, "/v1/trip/match-with-layover").permitAll()
                .requestMatchers(HttpMethod.GET, "/v1/trip/match-with-layover").permitAll()
